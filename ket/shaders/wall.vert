...
void main() {
    ...
    float gridZ = floor(worldYZ.y * 0.4);
    float buildingHeight = step(0.3, fract(gridY)) * step(0.3, fract(gridZ)) * elevation;

    vec3 newPos = position;
    newPos.x += buildingHeight * 0.3;

    vElevation = buildingHeight;
